...
gdp_growth_long <- GDP_Growth_Clean_Concise_Dataset_2018_2024_Annual %>%
  pivot_longer(cols = starts_with("20"), names_to = "Year", values_to = "GDP_Growth") %>%
...
head(post_pandemic_growth, 5)   # Top 5 strongest recoveries
tail(post_pandemic_growth, 5)   # Bottom 5 weakest recoveries
```
