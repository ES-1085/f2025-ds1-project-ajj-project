...
```{r load-data}
Annual_GDP_Growth_OECD_and_non_OECD <- read_excel("/cloud/project/data/Annual GDP Growth OECD and non-OECD.xlsx")
# View(Annual_GDP_Growth_OECD_and_non_OECD)

Annual_GDP_Per_Capita_OECD_and_Non_OECD <- read_excel("/cloud/project/data/Annual GDP Per Capita OECD and Non-OECD.xlsx")
# View(Annual_GDP_Per_Capita_OECD_and_Non_OECD)
```
